    ...
    return (
        <>
            <Section>
                ...
                <CaptionedImage src="/assets/seasons/grt-2018.JPG" alt="GRT 2017-2018" className="max-w-3xl mx-auto">
                    GRT 2017-2018
                </CaptionedImage>
            </Section>
            ...
            <Section secondary>
                ...
                <img src="/assets/seasons/2018-design.jpg" alt="Prototyping and design" className="rounded w-full max-w-3xl mx-auto mb-6" />
            ...
            <Section>
                ...
                <CaptionedImage src="/assets/seasons/2018-lone-star.JPG" alt="Robot depositing power cube" className="max-w-2xl mx-auto mb-16">
                ...
                <img src="/assets/seasons/2018-comps.JPG" alt="2018 robot at competition" className="rounded w-full max-w-2xl mx-auto" />
