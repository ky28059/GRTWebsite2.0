...
export default function Mentors() {
    return (
        <Layout>
            ...
            <div className="rounded p-6 mb-6 bg-gray-50 font-light">
            ...
            <p className="font-light mb-4">
                ...
                which means they all have something unique and valuable to teach us.
            </p>
            <p className="font-light">
                Our mentors are extremely adept at giving us the tools we need to find answers and innovate;
                they "teach us to fish."
            </p>
        </Layout>
    )
}
