    ...
    return (
        <Layout>
            ...
            <p className="font-light mb-6">
                ...
                Each season, the business team arranges venues for us to showcase our robot and promote FIRST. We participate in many community events including the Palo Alto May Fete Parade, JLS Back to School Night, and the Nixon Elementary School Science Night.
            </p>
            <p className="font-light mb-6">
            ...
            <CaptionedImage src="/assets/subgroups/2023-jls-btsn.jpg" alt="JLS Back-to-School Night" className="max-w-2xl mx-auto mb-4">
            ...
            <CaptionedImage src="/assets/subgroups/2023-nixon-science-night.jpg" alt="Nixon Science Night" className="max-w-2xl mx-auto mb-4">
