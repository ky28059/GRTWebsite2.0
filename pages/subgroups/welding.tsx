...
export default function Welding() {
    return (
        <Layout>
            ...
            <p className="font-light mb-6">
                Due to the coronavirus pandemic, no new members were able to be trained in welding this year. The tight
                proximity of the welding room and the hands-on nature of welding made it impossible to teach, and virtual
                lessons and videos — although incredibly insightful — are no substitute for practice. Unfortunately, all
